...
%%END LATEX_FONTENC
  ...
  \fancypagestyle{fancyplain}{
    ...
    \fancyfoot[LO, RE]{\bfseries\scriptsize Copyright © The National Institute of Advanced Industrial Science and Technology (AIST）}
  }
...
%%END PDF_HYPERLINKS
  ...
  \vspace*{7cm}
  \begin{center}%
  {\Huge Implementation of Trusted Execution Environment Provisioning (TEEP) Protocol}\\
  \vspace*{0.5cm}
  {\Huge TEEP-Device}\\
  \vspace*{1cm}
  {\Huge User's Manual}\\
  \vspace*{2cm}
  {\Large The National Institute of Advanced Industrial Science and Technology}\\
  \vspace*{1cm}
  \def\todaydate{\leavevmode\hbox{\the\year-\twodigits\month-\twodigits\day}}
