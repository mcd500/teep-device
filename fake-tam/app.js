...
const server = http.createServer((req, res) => {
	/* the plaintext TA */
	var f, f_pt = fs.readFileSync("/var/www/node/8d82573a-926d-4754-9353-32dc29997f74.ta", function(err, data) {
		console.log(data);
	});

	jose.JWE.createEncrypt({ alg: 'RSA1_5', contentAlg: 'A128CBC-HS256', format: "flattened" }, jwk_tee_pubkey).update(f_pt).final().then
					(function(result) {
